...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* SkillDelta Logo and CTA Buttons */}
      <div className="relative z-10 space-y-6 md:space-y-8 lg:space-y-10 flex flex-col items-center justify-center mt-16 md:mt-[80px] lg:mt-[100px]">
        {/* SkillDelta Logo */}
        <div className="flex flex-col items-center gap-4">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Untitled_design__3_-removebg-preview-qtZVCC40on1XeXBMHebXZg2jXlkdNm.webp"
            alt="SkillDelta Logo"
            width={400}
            height={120}
            ...
            priority
          />
          <p className="text-muted-foreground text-sm md:text-base lg:text-lg font-medium">AI-powered skill growth.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <Link href="#" onClick={handleLearnMore}>
            <Button className="bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 border border-primary/30">
              Learn More
            </Button>
          </Link>
        </div>
